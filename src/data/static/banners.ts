...
export const classicDemoBanner = [
  {
    ...
    image: {
      mobile: {
        url: "https://cdn.pnj.io/images/promo/146/chouchou_494x247CTA.jpg",
        width: 470,
        height: 232,
      },
      desktop: {
...
export const homeElegantHeroSlider = [
	{
		...
		image: {
			mobile: {
				url: "/assets/images/banner/PNJ1.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
				url: "/assets/images/banner/PNJ2.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
				url: "/assets/images/banner/PNJ3.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
  {
		...
		image: {
			mobile: {
				url: "/assets/images/banner/PNJ4.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
  {
		...
		image: {
			mobile: {
				url: "/assets/images/banner/PNJ5.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
