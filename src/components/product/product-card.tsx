...
const ProductCard: FC<ProductProps> = ({
  ...
  return (
    <div
          className={cn(
            "group box-border overflow-hidden flex rounded-md cursor-pointer ltr:pr-0 rtl:pl-0 pb-2 lg:pb-3 flex-col items-start bg-white transition duration-200 ease-in-out transform hover:-translate-y-1 hover:md:-translate-y-1.5 hover:shadow-product"
        ...
        >
          ...
          >
            ...
            /> */}
            <img src="https://vcdn1-giaitri.vnecdn.net/2022/10/24/-8754-1666626354.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=ulXyjj4k2WsNOBaHaCMMRQ"/>
          </div>
          <div
            className={cn(
              "w-full overflow-hidden ltr:pl-0 rtl:pr-0 ltr:lg:pl-2.5 ltr:xl:pl-4 rtl:lg:pr-2.5 rtl:xl:pr-4 ltr:pr-2.5 ltr:xl:pr-4 rtl:pl-2.5 rtl:xl:pl-4"
              
              
            )}
          >
            <h2
              className={cn("text-heading font-semibold truncate mb-1 text-sm md:text-base"
            ...
            <div
              className={`text-heading font-semibold text-sm sm:text-base mt-1.5 space-x-1 rtl:space-x-reverse  3xl:text-lg lg:mt-2.5`}
            >
                <>
